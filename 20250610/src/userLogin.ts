...
// 타입을 어서션을 사용해서 어떤 요소인지의 타입을 지정
// HTMLInputElement라고 지정을 해서 이후에 코드의 내요ㅕㅇ에 요소에 있는 이벤트를 등록해서 사용할수 있다
...
const loginBnt = document.querySelector(".login-btn") as HTMLButtonElement
