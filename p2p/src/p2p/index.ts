...
const peers = [ "ws://192.168.0.5:3000"  ]
// const peers2 = ["ws://192.168.0.75:3001","ws://192.168.0.5:3001", "ws://192.168.0.235:3001", "ws://192.168.0.116:3003"  ]
const p2pNode = new P2PNode(3000,["ws://192.168.0.75:3001"] );
const p2pNode2 = new P2PNode(3001, ["ws://192.168.0.75:3000"] );
initBalance(p2pNode)
